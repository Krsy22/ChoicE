...
with torch.no_grad():
    test_lp_list_rank = []    
    ent_embs, rel_embs, ent_str_results, ent_vis_results, ent_txt_results, rel_str_results, rel_vis_results, rel_txt_results = model()
    #total_expert_counts = torch.zeros(3, dtype=torch.int).cuda()
